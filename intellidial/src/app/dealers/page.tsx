...
export default function DealersPage() {
  ...
  const faqs = [
    {
      question: "How fast do you call the lead?",
      answer:
        "We call your new lead within 60 seconds of receiving the enquiry. You can forward leads from AutoTrader or connect HubSpot so we sync new leads automatically.",
    },
    {
      question: "Does it work with AutoTrader?",
      answer:
        "Yes. You forward the lead's enquiry to us, or we pull leads from HubSpot if you sync AutoTrader (or your listing site) into HubSpot. We call the lead within 60 seconds.",
    },
    {
      question: "Can it book test drives?",
      answer:
        "Yes. Our AI qualifies the buyer, answers questions about the car, and books a viewing or test drive. You get a notification with the confirmed time slot and full transcript.",
    },
    {
      question: "Do I get the recording?",
      answer:
        "Yes. Every call is recorded and fully transcribed. You can review in your IntelliDial dashboard and, if you use HubSpot, the recording link and transcript appear on the contact record.",
    },
    {
      question: "Is my data secure?",
      answer:
        "Yes. All data is encrypted and stored securely. We never share your leads or results with third parties.",
    },
  ];
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 md:h-20">
            ...
            <div className="hidden md:flex items-center gap-8">
              <a href="/dealers" className="text-teal-600 font-medium">
                Dealers
              </a>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t border-slate-100 px-4 py-4 space-y-3 shadow-lg">
            <a href="/dealers" className="block text-teal-600 font-medium py-2" onClick={() => setMobileMenuOpen(false)}>
              Dealers
            </a>
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <FadeInOnScroll delay={200}>
              <p className="mt-6 text-lg sm:text-xl lg:text-2xl text-slate-700 leading-relaxed max-w-3xl mx-auto font-medium">
                Qualify the buyer, automated booking for viewings and test drives, and get a notification — whenever leads come in.
                <span className="block mt-3 text-slate-600 font-normal">
                  We call your new lead within 60 seconds, ask the right questions, and qualify and book a viewing or test drive. The AI answers questions using the ad details and your business context (address, operating hours, etc.) from your website. Full transcript and recording every time.
                </span>
              </p>
            </FadeInOnScroll>
            ...
            <div id="talk-to-ai" className="mt-14 md:mt-16 max-w-2xl mx-auto scroll-mt-24 md:scroll-mt-28">
              <div className="text-center mb-6">
                ...
                <p className="text-slate-600 text-sm sm:text-base mt-1 max-w-lg mx-auto">
                  Ask about the 60-second callback or test drive booking — <span className="font-semibold text-teal-600">click below to start</span>
                </p>
              </div>
              <VoiceDemo ref={voiceDemoRef} variant="dealers" />
          ...
          <FadeInOnScroll delay={400}>
            <div className="mt-10 flex flex-wrap items-center justify-center gap-x-6 gap-y-3 text-sm text-slate-500">
              ...
              <div className="flex items-center gap-2 text-slate-600">
                <span className="font-medium text-teal-600">Try with your next 50 AutoTrader leads</span>
              </div>
            </div>
          </FadeInOnScroll>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap justify-center items-center gap-6 md:gap-10">
            <div className="flex items-center gap-2 text-slate-600">
              ...
              <div>
                <div className="font-bold text-slate-900">60 sec</div>
                <div className="text-xs text-slate-500">Lead callback</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 text-slate-600">
              ...
              <div>
                <div className="font-bold text-slate-900">Test drives</div>
                <div className="text-xs text-slate-500">Booked for you</div>
              </div>
            </div>
            <div className="w-px h-10 bg-slate-200 hidden sm:block"></div>
            <div className="flex items-center gap-2 text-slate-600">
        ...
        <div className="max-w-6xl mx-auto">
          <FadeInOnScroll>
            <div className="text-center mb-12">
              ...
              <p className="mt-4 text-xl text-slate-600">Three steps to never miss a lead</p>
            </div>
          </FadeInOnScroll>
          ...
          <FadeInOnScroll delay={100}>
            <div className="mb-16">
              <img 
                src="/howitworks_dealers.png" 
                alt="How it works for dealers: Forward enquiry or connect HubSpot, we call in 60 seconds and book a viewing, you get the alert and HubSpot updates" 
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-12">
            ...
            <FadeInOnScroll delay={0}>
              <div className="relative">
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-bold text-slate-900 mb-3">Send us the lead</h3>
                  <p className="text-slate-600">
                    Forward the lead&apos;s enquiry from AutoTrader (or your listing site), or connect HubSpot so we sync new leads automatically.
                  </p>
                </div>
            ...
            <FadeInOnScroll delay={150}>
              <div className="relative">
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-bold text-slate-900 mb-3">We call within 60 seconds</h3>
                  <p className="text-slate-600">
                    Our AI calls your new lead, qualifies them, answers questions about the car, and books a viewing or test drive. Every call is recorded.
                  </p>
                </div>
                <div className="hidden md:block absolute top-10 left-[60%] w-[80%] h-0.5 bg-gradient-to-r from-teal-300 to-transparent"></div>
              </div>
            ...
            <FadeInOnScroll delay={300}>
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">You get the result</h3>
                <p className="text-slate-600">
                  Notification: qualified lead and confirmed time slot. Full transcript and recording in your dashboard — or we sync to HubSpot, or you get an email with the details.
                </p>
              </div>
            </FadeInOnScroll>
          </div>
      ...
      <section id="use-cases" className="py-20 md:py-28 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-slate-50 to-white">
        <div className="max-w-6xl mx-auto">
          <FadeInOnScroll>
            <div className="text-center mb-16">
              ...
              <h2 className="font-display text-3xl sm:text-4xl font-bold text-slate-900">
                Built for dealership speed-to-lead
              </h2>
              <p className="mt-4 text-xl text-slate-600">
                Call every AutoTrader (or similar) enquiry back in 60 seconds — qualify and book before your competitors
              </p>
            </div>
          </FadeInOnScroll>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: Clock, title: "60-second callback", desc: "We call your new lead within 60 seconds so you never lose a hot enquiry to slow follow-up." },
              { icon: CalendarCheck, title: "Qualify & book test drives", desc: "The AI qualifies the buyer, answers questions about the car, and books a viewing or test drive." },
              { icon: FileAudio, title: "Full transcript & recording", desc: "Every call is recorded and transcribed. Review in your dashboard or in HubSpot." },
              { icon: BarChart3, title: "HubSpot sync", desc: "Import leads by status or list, sync call results and Lead Status, notes and recording links to the contact." },
              { icon: Lock, title: "South African number", desc: "Higher answer rates with a local SA caller ID so leads pick up." },
              { icon: Shield, title: "No missed leads", desc: "Join dealers who never miss an AutoTrader lead — we call whenever leads come in." },
            ].map((benefit, i) => (
              <FadeInOnScroll key={i} delay={i * 50}>
                <div className="text-center group">
                  <div className="w-14 h-14 bg-gradient-to-br from-teal-50 to-teal-100 rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:from-teal-500 group-hover:to-teal-700 transition-all duration-300">
                    <benefit.icon className="w-7 h-7 text-teal-600 group-hover:text-white transition-colors" />
                  </div>
      ...
      <section className="py-20 md:py-28 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              {
                quote: "IntelliDial called our lead back in under a minute and booked a viewing. We never miss an AutoTrader enquiry now.",
                author: "Dealer Principal",
                company: "Cape Town dealership",
                rating: 5,
              },
              {
              ...
              <div className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-3xl p-8 md:p-12 text-center overflow-hidden border border-teal-500/20 shadow-2xl shadow-teal-500/10">
                ...
                <div className="relative z-10">
                  <h2 className="font-display text-3xl sm:text-4xl font-bold text-white mb-4 text-glow">
                    Ready to never miss an AutoTrader lead?
                  </h2>
                  <p className="text-xl text-slate-300 mb-8">
                    Start with a free pilot—50 calls on us. Try with your next 50 AutoTrader leads.
                  </p>
          ...
          <div className="mb-12">
            ...
            <div className="max-w-md">
              ...
              <p className="text-slate-400 mb-4 max-w-sm text-sm">
                Call every AutoTrader lead back in 60 seconds. Qualify the buyer,
                book a test drive, get the transcript.
              </p>
